...
const TYPEFAST_SCREENS = [
  {
    src: "/images/projects2/1.png",
    alt: "TypeFast main typing interface with minimalist dark theme",
    caption: "Main Interface — minimalist typing test with mode & difficulty selector",
  },
  {
    src: "/images/projects2/2.png",
    alt: "TypeFast results screen showing WPM, accuracy and a WPM-over-time chart",
    caption: "Results — WPM, accuracy, raw score, and live performance chart",
  },
  {
    src: "/images/projects2/3.png",
    alt: "TypeFast global leaderboard showing top scores by user",
    caption: "Global Leaderboard — real-time rankings powered by PostgreSQL",
  },
  {
    src: "/images/projects2/4.png",
    alt: "TypeFast user profile showing account details and personal records",
    caption: "Profile — account details and personal best records",
  },
  {
    src: "/images/projects2/5.png",
    alt: "TypeFast results with score submitted to leaderboard confirmation",
    caption: "Score Submission — results saved to the global leaderboard",
  },
];
...
const ProjectDetail = () => {
  ...
  // Project-specific content flags
  const isScentify = project.slug === "scentify";
  const isTypeFast = project.slug === "typefast";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24">
        ...
        {/* TypeFast project explanation + screenshots */}
        {isTypeFast && (
          <section className="section-padding">
            <div className="container mx-auto max-w-5xl">
              <motion.div
              ...
              >
                ...
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-heading font-bold mb-4">About the project</h2>
                    <p className="text-muted-foreground leading-relaxed mb-4">
                      <strong>TypeFast</strong> is a high-performance, minimalist typing test platform
                      inspired by Monkeytype. It supports multiple modes (Time, Words, Quote), difficulty
                      levels, and a real-time global leaderboard.
                    </p>
                    <p className="text-muted-foreground leading-relaxed">
                      Users can create an account, compete on the global leaderboard, and track their
                      personal bests over time. The app features smooth custom caret animations and
                      a fluid, distraction-free interface optimized for speed.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid sm:grid-cols-1 gap-4">
                      <div className="glass rounded-xl p-5">
                        <Smartphone className="w-8 h-8 text-primary mb-2" />
                        <h3 className="font-heading font-semibold text-sm mb-1">Frontend</h3>
                        <p className="text-xs text-muted-foreground">
                          React + Vite with complex state management for real-time keystroke validation,
                          theme switching, and custom caret animations.
                        </p>
                      </div>
                      <div className="glass rounded-xl p-5">
                        <Server className="w-8 h-8 text-primary mb-2" />
                        <h3 className="font-heading font-semibold text-sm mb-1">Backend</h3>
                        <p className="text-xs text-muted-foreground">
                          Express.js REST API with PostgreSQL via Prisma — handling secure user
                          authentication and global leaderboard data.
                        </p>
                      </div>
                      <div className="glass rounded-xl p-5">
                        <Gauge className="w-8 h-8 text-primary mb-2" />
                        <h3 className="font-heading font-semibold text-sm mb-1">UX & Performance</h3>
                        <p className="text-xs text-muted-foreground">
                          Lag-free typing experience via optimized React rendering and smooth,
                          custom-built caret animations.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                {/* Right: App screens — click to fullscreen */}
                <div className="space-y-6 lg:sticky lg:top-28">
                  <h2 className="text-xl font-heading font-bold">App screens</h2>
                  <p className="text-sm text-muted-foreground">Click an image to view full size</p>
                  <div className="grid grid-cols-2 gap-4">
                    {TYPEFAST_SCREENS.map((screen, i) => (
                      <motion.button
                        key={screen.src}
                        type="button"
                        initial={{ opacity: 0, y: 16 }}
